...
//  Slots_App
//
//  Created by Rishi Boyat on 2024-10-12.
//  Copyright © 2024 Rishi Boyat. All rights reserved.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Rectangle()
                .foregroundColor(Color(red: 188/255, green: 23/255, blue: 23/255))
            ...
            VStack {
                ...
                HStack (spacing: 20) {
                    ...
                    VStack {
                        ...
                        Text("$\(betAmount)").padding(.top, 10).font(.footnote).foregroundColor(.white).bold()
                    }
                    ...
                    VStack {
                        ...
                        Text("$\(betAmount * 5)").padding(.top, 10).font(.footnote).foregroundColor(.white).bold()
                    }
